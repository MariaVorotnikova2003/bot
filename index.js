const {
  ...
  bot.command('recipes', async (ctx) => {
    try {
      await ctx.replyWithHTML('<b>Рецепты</b>', Markup.inlineKeyboard(
        [
          [Markup.button.callback('Завтрак', 'btn_1'), Markup.button.callback('Обед', 'btn_2'), Markup.button.callback('Ужин', 'btn_3')]
        ]
      ))
    } catch (e) {
      console.error(e)
  ...
  addActionBot('btn_1', 'D:/BOT/img/1.jpg', my_const.text1, true)
  addActionBot('btn_2', './img/2.jpg', my_const.text2, true)
  addActionBot('btn_3','D:/BOT/img/1.jpg', my_const.text3,  true)
